  ...
  return (
    <div style={textualStyle}>
      ...
      <p style={{ marginBottom: "20px" }}>
        ...
        E-Shop domain strictly act uniquely as an educational development
      ...
      <p style={{ marginBottom: "15px" }}>
        The materials spanning the E-Shop interface may heavily include dynamic
      ...
      <p style={{ marginBottom: "15px" }}>
        E-Shop operates completely independent domains and takes strictly zero
